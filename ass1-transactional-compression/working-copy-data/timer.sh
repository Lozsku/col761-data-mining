...
python3 -u check_loss.py "test2_copied1.dat" "decompressed.dat" > loss_out.txt 2> loss_err.txt
python3 -u compression_ratio.py "test2_copied1.dat" "compressed.dat" > compression_out.txt 2> compression_err.txt
end="$(date +%s.%N)"
echo "end: $end"
echo "time = "
